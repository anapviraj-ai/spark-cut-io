      ...
      img.onload = () => {
        ...
        for (let i = 0; i < width * height; i++) {
          ...
          if (dist <= tolerance) {
            ...
            data[pIdx + 3] = Math.min(
              255,
              Math.max(0, Math.floor(255 * (alphaRatio * alphaRatio))),
            );
          }
        }
      ...
      >
        ...
        {isProcessing && (
          <div className="relative flex flex-1 flex-col items-center justify-center rounded-xl bg-card/60 p-8 text-center">
            ...
            <p className="mt-1 font-mono text-sm text-primary">{processingStage}</p>
        ...
        {!isProcessing && result && (
          <div className="flex flex-1 flex-col">
            ...
            <div
              ...
              className="group relative h-[320px] w-full cursor-ew-resize select-none overflow-hidden rounded-xl border border-border"
            >
            ...
            <div className="mt-3 flex flex-wrap items-center justify-between gap-3 px-1 text-xs text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" variant="hero" asChild className="h-8 gap-1.5 text-xs">
                  <a
